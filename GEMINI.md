# If you are assigned a GH issue number, you can find it at https://github.com/shaunhickson/youtube-url-replacer/issues/<N>, where <N> is the issue number.
...
# If you are writing a doc, add it to the docs/ subdirectory off the project root.
